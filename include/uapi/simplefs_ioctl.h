...
#define SIMPLEFS_IOC_GET_META                                                 \
  _IOWR (SIMPLEFS_IOCTL_MAGIC, 3, struct simplefs_meta_req)
#define SIMPLEFS_IOC_GET_SECTOR_MAP                                           \
  _IOWR (SIMPLEFS_IOCTL_MAGIC, 4, struct simplefs_sector_map_req)
